    ...
    <nav class="admin">
      <ul>
        <h1>CPMS</h1>
          ...
          <li><a href="displaycase.php">
        <svg fill="#FFFFFF" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
            <path d="M21 5.5l-1.9-1.9c-.19-.19-.45-.3-.7-.3H5.7c-.25 0-.52.11-.7.3L3 5.5V18c0 .83.67 1.5 1.5 1.5h16c.83 0 1.5-.67 1.5-1.5V5.5zM19 18H5V7.91l7 4.18 7-4.18V18zm-9-6.75l-4.5-2.67L7 12.25V16h3v-3.75zm3 0V16h3v-3.75l-.5-.92-4.5 2.67z"/>
            <path d="M0 0h24v24H0z" fill="none"/>
        </svg>
         Case</a></li>
