<?php
  ...
  $password =  mysql_real_escape_string($_POST['password']);
    if(empty($name) || empty($password)){
        ...
        $query1=mysql_query("SELECT * FROM `officer` WHERE id AND name='$name' and password='$password'") or die(mysql_error());
...
<html>
  ...
  <div class="animated fadeIn">
    ...
    <div class="cover officer text-center">
    <svg fill="#fff" height="148" viewBox="0 0 24 24" width="148" xmlns="http://www.w3.org/2000/svg" class="shad">
      ...
      <div class="padd">
        <div class="col-lg-12 text-center">
              ...
              <br>
              <!-- Don't have an acccount ? <a href="officer-register.php">Sign Up</a> -->
        </div>
      </div>
      <div class="links">
